    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="bg-gradient-to-r from-primary to-primary-dark">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Book your perfect ride now and experience hassle-free motorcycle
            rental in Bali.
          </p>
          <a
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
              "Hello! I'd like to rent a motorcycle."
            )}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white hover:bg-gray-100 text-primary font-bold rounded-full transition-colors duration-200 shadow-lg"
          >
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Rental Motor. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
